...
const contentListNoTitle = {
    ...
    Wallet: <Anchor affix={true} showInkInFixed={true} offsetTop={30}>
        <Link href="https://www.phonepe.com/app-download/" target="_blank" title="PhonePe" />
        <Link href="https://paytm.com/login" target="_blank" title="PayTM" />
        <Link href="https://play.google.com/store/apps/details?id=com.ippopay.store&hl=en_IN&gl=US" target="_blank" title="IppoPay" />
    </Anchor>,
    Card: <Form
        name="basic"
        labelCol={{
